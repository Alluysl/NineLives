...
execute if score @s ninelives.armor_added_by_us matches 1 run data modify entity @s ArmorItems set from entity @e[type=minecraft:armor_stand, tag=ninelives_internal_current_armor_template, limit=1] ArmorItems
