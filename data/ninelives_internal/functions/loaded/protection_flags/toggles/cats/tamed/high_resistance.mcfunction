...
# doHighResistanceProtection = 1 - doHighResistanceProtection
scoreboard players set #temp ninelives.globals 1
scoreboard players operation #temp ninelives.globals -= #doHighResistanceProtection ninelives.globals
