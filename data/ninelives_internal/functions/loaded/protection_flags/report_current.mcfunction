...
# TODO display armor params
execute if score #doArmorProtection ninelives.globals matches 1 run tellraw @s [{"text": "    ✔ ", "color": "green"}, {"text": "Armor (WIP)", "color": "white"}]
execute unless score #doArmorProtection ninelives.globals matches 1 run tellraw @s [{"text": "    ❌ ", "color": "red"}, {"text": "Armor (WIP)", "color": "white"}]
