...
# Bump generation IDs to warn players in case sanity breach interfered with parameters or storage
scoreboard players add #current ninelives.protection_flags_generation_id 1
scoreboard players add #current ninelives.armor_template_global_generation_id 1
