...
execute if score #doTotemProtection ninelives.globals matches 1 as @e[type=minecraft:cat] if data entity @s Owner run function ninelives_internal:loaded/totem/apply_one
